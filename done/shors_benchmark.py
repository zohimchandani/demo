...
import numpy as np
from hello_world_qiskit import QuantumCircuit, QuantumRegister, ClassicalRegister
...
def controlled_Ua(n,a,exponent,N):
    ...
    #MIKETODO Fix the name below for high qubit counts
    qc = QuantumCircuit(qr_ctl, qr_x, qr_main,qr_ancilla, name = "C-U^")
...
import argparse
def get_args():
    parser = argparse.ArgumentParser(description="Shors Benchmark")
...
if __name__ == '__main__': 
    ...
    run(min_qubits=args.min_qubits, max_circuits=args.max_circuits,
        max_qubits=args.max_qubits,	num_shots=args.num_shots,
	method=args.method,
